...
/**
 * 最高品質問題生成エンジンv2 - Worker3専用版
 *
 * 目的: カテゴリ 1-3.5 (基本・設備・従業員・営業時間前半)
 * 目標問題数: 750問
 *
 * 実行方法:
 * export ANTHROPIC_API_KEY="sk-ant-..."
 * node ultimate-problem-generator-v2-worker3.js
 */
...
const CONFIG = {
  ...
  outputPath: path.join(__dirname, '../data/ultimate_problems_worker3.json'),
  learningPath: path.join(__dirname, '../data/learning_stats_worker3.json'),
  targetProblems: 750,
  categories: [
  "営業許可・申請手続き",
  "建物・設備基準",
